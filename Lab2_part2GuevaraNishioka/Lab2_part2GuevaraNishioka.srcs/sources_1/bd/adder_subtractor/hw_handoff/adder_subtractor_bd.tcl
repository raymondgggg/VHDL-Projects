...
################################################################
# This is a generated script based on design: adder_subtractor
#
...
# source adder_subtractor_script.tcl
...
proc create_root_design { parentCell } {
  ...
  set sumOrSub [ create_bd_port -dir O -from 4 -to 0 -type data sumOrSub ]
  ...
  connect_bd_net -net FA_3_Cout [get_bd_pins FA_3/Cout] [get_bd_pins xorGate_0/y]
  ...
  connect_bd_net -net xlconcat_0_dout [get_bd_ports sumOrSub] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins FA_0/Cin] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins util_vector_logic_1/Op1] [get_bd_pins util_vector_logic_2/Op1] [get_bd_pins util_vector_logic_3/Op1] [get_bd_pins xlconstant_0/dout] [get_bd_pins xorGate_0/x]
  ...
  connect_bd_net -net xlslice_4_Dout [get_bd_pins util_vector_logic_0/Op2] [get_bd_pins xlslice_4/Dout]
  connect_bd_net -net xlslice_5_Dout [get_bd_pins util_vector_logic_1/Op2] [get_bd_pins xlslice_5/Dout]
  connect_bd_net -net xlslice_6_Dout [get_bd_pins util_vector_logic_2/Op2] [get_bd_pins xlslice_6/Dout]
  connect_bd_net -net xlslice_7_Dout [get_bd_pins util_vector_logic_3/Op2] [get_bd_pins xlslice_7/Dout]
  connect_bd_net -net xorGate_0_z [get_bd_pins xlconcat_0/In4] [get_bd_pins xorGate_0/z]
