...
HD_PWD='C:/Programs/Lab2_part2GuevaraNishioka/Lab2_part2GuevaraNishioka.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_subtractor_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder_subtractor_wrapper.tcl -notrace
