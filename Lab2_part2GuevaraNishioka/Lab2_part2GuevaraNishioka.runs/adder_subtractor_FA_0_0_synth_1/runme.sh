...
HD_PWD='C:/Programs/Lab2_part2GuevaraNishioka/Lab2_part2GuevaraNishioka.runs/adder_subtractor_FA_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_subtractor_FA_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_subtractor_FA_0_0.tcl
