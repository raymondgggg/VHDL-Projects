...
#
# Generated by export_simulation on Thu Feb 20 10:33:15 -0800 2020
#
################################################################################
...
'-reset_run' switch to the './adder_subtractor.sh' script.

./adder_subtractor.sh -reset_run
...
./adder_subtractor.sh -noclean_files

For more information on the script, please type './adder_subtractor.sh -help'.
