...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xlslice_v1_0_2 -L xlconstant_v1_1_6 -L xlconcat_v2_1_3 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot adder_2bit xil_defaultlib.adder_2bit xil_defaultlib.glbl -log elaborate.log
}
