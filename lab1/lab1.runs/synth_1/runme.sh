...
HD_PWD='C:/Programs/lab1/lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_2bit_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_2bit_wrapper.tcl
