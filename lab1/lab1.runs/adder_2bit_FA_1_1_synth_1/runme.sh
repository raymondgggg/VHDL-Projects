...
HD_PWD='C:/Programs/lab1/lab1.runs/adder_2bit_FA_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_2bit_FA_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_2bit_FA_1_1.tcl
