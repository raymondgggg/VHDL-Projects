...
HD_PWD='C:/Programs/Lab2-partI/Lab2_part2/Lab2_part2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_subtractor_4bit_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_subtractor_4bit_wrapper.tcl
