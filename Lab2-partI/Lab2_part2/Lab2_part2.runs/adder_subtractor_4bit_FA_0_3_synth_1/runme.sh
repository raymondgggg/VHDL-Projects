...
HD_PWD='C:/Programs/Lab2-partI/Lab2_part2/Lab2_part2.runs/adder_subtractor_4bit_FA_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_subtractor_4bit_FA_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_subtractor_4bit_FA_0_3.tcl
