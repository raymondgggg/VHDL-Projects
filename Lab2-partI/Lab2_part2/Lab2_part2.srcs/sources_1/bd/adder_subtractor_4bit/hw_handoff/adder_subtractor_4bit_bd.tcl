...
################################################################
# This is a generated script based on design: adder_subtractor_4bit
#
...
# source adder_subtractor_4bit_script.tcl
...
set design_name adder_subtractor_4bit
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net xlslice_4_Dout [get_bd_pins FA_0/B] [get_bd_pins xlslice_4/Dout]
  connect_bd_net -net xlslice_5_Dout [get_bd_pins FA_1/B] [get_bd_pins xlslice_5/Dout]
  connect_bd_net -net xlslice_6_Dout [get_bd_pins FA_2/B] [get_bd_pins xlslice_6/Dout]
  connect_bd_net -net xlslice_7_Dout [get_bd_pins FA_3/B] [get_bd_pins xlslice_7/Dout]
