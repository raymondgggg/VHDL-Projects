...
#
# Generated by export_simulation on Wed Feb 19 01:29:34 -0800 2020
#
################################################################################
...
'-reset_run' switch to the './adder_subtractor_4bit.sh' script.

./adder_subtractor_4bit.sh -reset_run
...
./adder_subtractor_4bit.sh -noclean_files

For more information on the script, please type './adder_subtractor_4bit.sh -help'.
