...
HD_PWD='C:/Programs/Lab2-partI/Lab2_partII/Lab2_partII.runs/adder_2bit_FA_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_2bit_FA_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_2bit_FA_2_0.tcl
