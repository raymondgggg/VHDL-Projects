...
HD_PWD='C:/Programs/Lab2_GuevaraNishioka/Lab2_GuevaraNishioka.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log logic_circuit_F1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source logic_circuit_F1.tcl
