...
# module references:
# ALU, PC, alu_control, controlUnit, instmem, programCounterADD, regfile
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set alutOut [ create_bd_port -dir O -from 31 -to 0 -type data alutOut ]
  set cin [ create_bd_port -dir I -type data cin ]
  ...
  connect_bd_net -net ALU_0_ALUOut [get_bd_ports alutOut] [get_bd_pins ALU_0/ALUOut] [get_bd_pins regfile_0/write_data]
  ...
  connect_bd_net -net cin_1 [get_bd_ports cin] [get_bd_pins ALU_0/Carryin]
  connect_bd_net -net clock_1 [get_bd_ports clock] [get_bd_pins PC_0/clock] [get_bd_pins regfile_0/clock]
  ...
  connect_bd_net -net programCounterADD_0_programCounterOut [get_bd_pins PC_0/PCin] [get_bd_pins programCounterADD_0/programCounterOut]
  connect_bd_net -net programCounter_0_Dout [get_bd_pins PC_0/PCout] [get_bd_pins instmem_0/read_inst] [get_bd_pins programCounterADD_0/programCounterIn]
  ...
  connect_bd_net -net xlslice_4_Dout [get_bd_pins alu_control_0/funct] [get_bd_pins xlslice_4/Dout]
